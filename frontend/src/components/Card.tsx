        ...
        <div className="p-6">
          <h5
            ...
            <Link to={`/Plants/${id}`}>
              <button
                type="button"
                className="inline-block my-6 bg-emerald-800 rounded-full mr-6 bg-primary my-2 px-4 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white transition duration-150"
              >
                Learn More
              </button>
            </Link>
